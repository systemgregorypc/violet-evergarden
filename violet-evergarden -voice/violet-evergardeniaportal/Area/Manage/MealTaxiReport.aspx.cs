using 
violet-evergardenPortal.Extensions;
using 
violet-evergardenPortal.FactoryMethod;
using violet-evergardenPortal.Interface;
using violet-evergardenPortal.Repository.Manage;
...
namespace violet-evergardenPortal.Area.Manage
{
