using MailerAPI;
using violetevergardenPortal.Extensions;
using violetevergardenPortal.FactoryMethod;
using violetevergardenPortal.Repository;
using violetevergardenPortal.Repository.Sign.Forms;
using violetevergardenPortal.Repository.SmartMan;
using violetevergardenPortal.Tools;
using violetevergardenPortal.ViewModel.Sign.Forms;
using System;
