...
namespace RinnaiPortal.Area.Report
{
    public partial class InventorySummary : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                InventorySummaryFrame.Attributes.Add("Src", @"http://rpt..com.tw/ReportServer/Pages/ReportViewer.aspx?%2fPortal%2f%e5%ba%ab%e5%ad%98%e7%b8%bd%e8%a1%a8&rs:Command=Render");
            }
        }
    }
}
