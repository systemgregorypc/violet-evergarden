...
namespace violet-evergardenPortal.Area.Report
{
    public partial class ProductionSalesStockNew : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ProductionSalesStockNewFrame.Attributes.Add("Src", @"http://rpt..com.tw/ReportServer/Pages/ReportViewer.aspx?%2fPortal%2f%e7%94%a2%e9%8a%b7%e5%ad%98%e5%a0%b1%e8%a1%a8(%e6%96%b0)&rs:Command=Render");
            }
        }
    }
}
